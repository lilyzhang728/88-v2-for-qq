				...
				<view class="comment-content-footer">
					...
					<view class="comment-content-footer-right">
						...
						<view class="comment-content-footer-right-reply">
							<van-icon v-if="!hideReply" name="comment" size="40rpx" color="#D7D7D7" @click="handleReply(item, 1, index)" />
						</view>
					</view>
				</view>
				...
				<view class="comment-content-level2" v-for="(reply, subIndex) in item.descendants" :key="subIndex">
					...
					<view class="comment-content-footer">
						...
						<view class="comment-content-footer-right">
							...
							<view class="comment-content-footer-right-reply">
								<van-icon v-if="!hideReply" name="comment" size="40rpx" color="#D7D7D7" @click="handleReply(reply, 2, index, subIndex)" />
							</view>
						</view>
					</view>
				</view>
