...
<template>
	<view class="badge-box">
		<view class="badge-title">
			...
			<text class="badge-title-right" @tap="toMyBadge" v-if="badgeList.length">查看/添加更多徽章 > </text>
		</view>
		<view class="badge-content" v-if="badgeList.length">
			<view class="badge-item" v-for="(item,index) in badgeList" :key="index" @tap="showDetail(item)">
		...
		<view class="badge-content-empty" v-if="!badgeList.length">
